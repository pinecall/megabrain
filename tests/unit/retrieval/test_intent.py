...
from megabrain.retrieval.intent import wants_tests
...
def test_the_penalty_STANDS_DOWN_when_tests_are_what_was_asked_for(tmp_path) -> None:
    ...
    from megabrain.retrieval.scoring.context import build_context
...
def test_the_recall_floor_ADMITS_a_test_when_tests_were_asked_for(tmp_path) -> None:
    ...
    from megabrain.retrieval.bundle.floors import file_floor
