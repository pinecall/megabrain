...
from megabrain.search.bundle._rank import rank_files
from megabrain.search.scoring.pipeline import score_chunks
...
def test_scoring_returns_the_query_vector_it_computed() -> None:
    ...
    """
    from megabrain.search.scoring.pipeline import Scored
...
def test_an_index_with_no_file_skeletons_still_answers(tmp_path: Path) -> None:
    ...
    chunk signal alone.
    """
    from tests.unit.search.factories import index_without_skeletons
...
def test_neighbour_order_does_not_depend_on_the_hash_seed() -> None:
    ...
    """
    code = ("from tests.unit.search.factories import tied_neighbours;"
